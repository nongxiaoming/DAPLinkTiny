...
{ .ep_num =  1, .style = FIFO_TXRX,   .maxpacket = 64, },
{ .ep_num =  2, .style = FIFO_TXRX,   .maxpacket = 64, },
{ .ep_num =  3, .style = FIFO_TXRX,   .maxpacket = 64, },
{ .ep_num =  4, .style = FIFO_TXRX,   .maxpacket = 128, },
{ .ep_num =  5, .style = FIFO_TXRX,   .maxpacket = 128, },
{ .ep_num =  6, .style = FIFO_TXRX,   .maxpacket = 256, },
{ .ep_num =  7, .style = FIFO_TXRX,   .maxpacket = 256, },
};
